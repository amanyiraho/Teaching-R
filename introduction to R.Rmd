...
xaringanExtra::use_xaringan_extra(c("tile_view", "animate_css", "clipboard"))
...
xaringanExtra::use_logo(
  image_url = "https://raw.githubusercontent.com/rstudio/hex-stickers/master/PNG/xaringan.png",width = "5px"
)
```
...
.pull-left[
incremental 1 dkbvkldbakbvcxkl]
...
````md
`r ''````{r, highlight.output=c(1,), comment=F}
head(iris)
```
````

```{r, highlight.output=c(T, F), echo=FALSE, comment=F}
head(iris)
```
